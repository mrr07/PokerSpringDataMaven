	...
	<main role="main" class="container">
		...
		<div class='card'>
		    ...
		    <div class='card-body'>
					...
					<form name='form' method="post" action="${pageContext.request.contextPath}/tavolo/InsertTavoloServlet" >
					
						<div class="form-row">
							<div class="form-group col-md-6">
								<label>Denominazione <span class="text-danger">*</span></label>
								<input type="text" name="denominazione" id="denominazione" class="form-control" placeholder="Inserire la denominazione" required>
							</div>
							
							<div class="form-group col-md-6">
								<label>Cifra Minima Per Entrare <span class="text-danger">*</span></label>
								<input type="number" name="cifraMinima" id="cifraMinima" class="form-control" placeholder="Inserire la cifra minima per entrare in partita" required>
							</div>
							
							<div class="form-group col-md-6">
								<label>Esperienza Minima Per Entrare <span class="text-danger">*</span></label>
